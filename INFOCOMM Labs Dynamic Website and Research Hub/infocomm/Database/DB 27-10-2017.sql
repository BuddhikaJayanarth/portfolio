...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2017 at 05:28 AM
...
ALTER TABLE `project_posts`
  ...
  ADD CONSTRAINT `project_posts_ibfk_2` FOREIGN KEY (`projectID`) REFERENCES `user_projects` (`projectID`) ON DELETE CASCADE ON UPDATE CASCADE;
