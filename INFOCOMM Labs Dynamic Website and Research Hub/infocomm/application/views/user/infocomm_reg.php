      ...
      <!--<div class="form-group has-feedback">
      	<input type="text" class="form-control" id="code" placeholder="Activation Code">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>-->
      <div class="form-group has-feedback">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="button" id="regBtn" data-id1="internal" class="btn btn-primary btn-block btn-flat">Register</button>
        </div>
        <!-- /.col -->
      </div>
