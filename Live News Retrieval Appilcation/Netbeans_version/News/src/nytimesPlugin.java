...
public class nytimesPlugin implements NewsPlugin, Callable<List<String[]>>{
    ...
    public List<String[]> GetHeadlines() throws MalformedURLException, IOException {
        ...
        try(ReadableByteChannel chan = Channels.newChannel(url.openStream())){
            ...
            File deletefile = new File("nytimes.html");
            if(deletefile.delete()){
                System.out.println("****************************************************************old nytimes.html deleted");
            }
        
            File file = new File("nytimes.html");
    ...
    public List<String[]> parsehtml() throws IOException {
        ...
        File downloadedhtml = new File("nytimes.html");
        Document parseddoc = Jsoup.parse(downloadedhtml, null);
        Elements headingelements = parseddoc.select("h2.story-heading");
